    ...
    resources: {
      en: {
        translation: {
          ...
          assignAsOperatorButton: "Assign as Operator",
          searchUsersByName: "Search users by name...",
          selectShelter: "Select shelter...",
          currentOperators: "Current Operators",
          searchOperatorsByName: "Search operators by name...",
          revoke: "Revoke",
      ...
      uk: {
        translation: {
          ...
          manageOperators: "Керування операторами",
          operators: "Оператори",
          assignOperators: "Призначити операторів",
          assignAsOperatorButton: "Призначити оператором",
          searchUsersByName: "Пошук користувачів за ім'ям...",
          selectShelter: "Оберіть укриття...",
          currentOperators: "Поточні оператори",
          searchOperatorsByName: "Пошук операторів за ім'ям...",
          revoke: "Забрати роль",
